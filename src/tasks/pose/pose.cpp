...
namespace yoloinfer
{
    ...
    YoloPose::YoloPose(const YoloParam &param) : YoloTask(param)
    {
        ...
        postproc_ = std::make_shared<PostProcPose>(postinfo);
    ...
    std::vector<Box> YoloPose::forward(const Image &image)
    {
    ...
    std::vector<Boxes> YoloPose::forward(const Images &images)
    {
